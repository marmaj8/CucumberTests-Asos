...
public class DriverManager {
    ...
    private static final String DEFAULT_DRIVERS_PATH = "drivers/windows/";


    public static WebDriver getDriver(String driverType) {
        // if test run from feature file
        if (System.getProperty("driver.path") == null) {
            System.setProperty("driver.path", DEFAULT_DRIVERS_PATH);
        }
